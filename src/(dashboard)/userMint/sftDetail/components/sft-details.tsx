...
export function SftDetails() {
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-2 gap-x-6 w-full mt-6 gap-4 md:gap-6">
        <div className="w-full h-full">
          <Card className="border-border/40 shadow-lg">
            ...
            <CardContent className="text-sm text-muted-foreground grid md:grid-cols-2 gap-6 w-full px-6 md:px-0">
      ...
      <Button className="rounded-lg w-full mt-8 mb-6 h-12 bg-blue-900 hover:bg-blue-950 dark:text-white dark:bg-blue-800 dark:hover:bg-opacity-75">
        Mint
      </Button>
    </>
  );
